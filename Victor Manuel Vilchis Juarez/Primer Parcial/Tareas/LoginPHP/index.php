...
if (!empty($_POST)){
    ...
    if($rows > 0){
        ...
        header("Location: Hola mundo.html");
    }else{
        echo "<script>
        alert('Contraseña o usuasrio incorrectos');
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Diablo</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Cov-2019</h4>
							</div>
