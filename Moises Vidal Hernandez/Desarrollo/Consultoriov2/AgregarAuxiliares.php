...
if(isset($_POST['guardar']))
{
  ...
  $inserta= $conexion->query("INSERT INTO usuarios VALUES ('$Id_empleado, $CURP, $Nombre, $Apellido_paterno, $Apellido_materno, $Telefono, $Fecha_nacimiento, $Direccion, $Codigo_postal, $Email, $Constrasenia')");
